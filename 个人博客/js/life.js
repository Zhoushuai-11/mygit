 ...
 $(function(){
 	$(document).ready(function(){
 		$('.leftmain ul div').eq(1).children('li').animate({top:'0px',left:'0px'},800)
 		.parents('ul').children('div').eq(0).children('li').delay(200).animate({top:'0px',left:'0px'},800)
 		$('.rightmain div').animate({left:'0px',top:'0px'},800)
 	})
 	$(document).scroll(function(){
 		if($(document).scrollTop()>150){
 			$('.leftmain ul div').eq(3).children('li').animate({top:'0px',left:'0px'},800)
 			.parents('ul').children('div').eq(2).children('li').delay(200).animate({top:'0px',left:'0px'},800)
 		}
 		if($(document).scrollTop()>300){
 			$('.leftmain ul div').eq(5).children('li').animate({top:'0px',left:'0px'},800)
 			.parents('ul').children('div').eq(4).children('li').delay(200).animate({top:'0px',left:'0px'},800)
 		}
 	})
 })
 $(function(){
